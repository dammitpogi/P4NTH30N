...
- **Updated build commands**:
  ...
  - Added project-specific build commands (C0MMON, HUN7ER, H4ND, H0UND)
- **Enhanced Lint and Format section**:
  - Added project-specific formatting (C0MMON/, HUN7ER/, H4ND/)
...
- **HUN7ER refactor**: Converted to interface-first flow with `IMongoUnitOfWork` usage, extracted phase methods, and isolated helper logic
- **Added domain value object**: `DollarsPerDay` in HUN7ER domain for DPD calculations
...
- **Added Dependency Flow section**:
  ...
  - Agent dependency relationships (HUN7ER, H4ND, H0UND)
...
- **Project count**: 9 active projects identified via glob:
  - CLEANUP, PROF3T, HUN7ER, H4ND, C0MMON, T00L5ET, UNI7T35T, H0UND, W4TCHD0G
