description: Adds a CRL distribution point URI where AD CS publishes certification
  revocations
synopses:
- Add-CACrlDistributionPoint [-Uri] <String> [-AddToCertificateCdp] [-AddToFreshestCrl]
