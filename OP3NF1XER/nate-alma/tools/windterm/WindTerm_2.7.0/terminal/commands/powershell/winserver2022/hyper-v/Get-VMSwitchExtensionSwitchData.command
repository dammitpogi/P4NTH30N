description: Gets the status of a virtual switch extension feature applied on a virtual
  switch
synopses:
...
- Get-VMSwitchExtensionSwitchData [-VMSwitch] <VMSwitch[]> [-FeatureName <String[]>]
  [-FeatureId <Guid[]>] [-Extension <VMSwitchExtension[]>] [-ExtensionName <String[]>]
  [-WhatIf] [-Confirm] [<CommonParameters>]
options:
