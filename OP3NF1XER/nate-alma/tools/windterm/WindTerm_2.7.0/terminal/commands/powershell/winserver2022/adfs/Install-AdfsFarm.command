description: Creates the first node of a new federation server farm
synopses:
...
- Install-AdfsFarm [-CertificateThumbprint <String>] [-Credential <PSCredential>]
  ...
  <Hashtable>] [-WhatIf] [-Confirm] [<CommonParameters>]
- Install-AdfsFarm [-CertificateThumbprint <String>] [-Credential <PSCredential>]
  -DecryptionCertificateThumbprint <String> -FederationServiceName <String> [-FederationServiceDisplayName
  <String>] -ServiceAccountCredential <PSCredential> -SigningCertificateThumbprint
  <String> -SQLConnectionString <String> [-OverwriteConfiguration] [-SSLPort <Int32>]
  [-TlsClientPort <Int32>] [-AdminConfiguration <Hashtable>] [-WhatIf] [-Confirm]
  [<CommonParameters>]
- Install-AdfsFarm [-CertificateThumbprint <String>] [-Credential <PSCredential>]
  -DecryptionCertificateThumbprint <String> -FederationServiceName <String> [-FederationServiceDisplayName
...
- Install-AdfsFarm [-CertificateThumbprint <String>] [-Credential <PSCredential>]
  ...
  <Int32>] [-TlsClientPort <Int32>] [-AdminConfiguration <Hashtable>] [-WhatIf] [-Confirm]
  [<CommonParameters>]
- Install-AdfsFarm [-CertificateThumbprint <String>] [-Credential <PSCredential>]
