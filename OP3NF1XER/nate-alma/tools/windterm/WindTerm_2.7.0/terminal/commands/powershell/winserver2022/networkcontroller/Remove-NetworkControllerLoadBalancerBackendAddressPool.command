description: This cmdlet removes a backend address pool from a load balancer resource
synopses:
- Remove-NetworkControllerLoadBalancerBackendAddressPool [-LoadBalancerId] <String>
