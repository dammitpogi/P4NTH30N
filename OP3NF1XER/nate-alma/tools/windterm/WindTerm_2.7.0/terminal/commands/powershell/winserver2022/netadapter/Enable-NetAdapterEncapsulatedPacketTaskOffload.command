description: Enables encapsulated packet task offload
synopses:
- Enable-NetAdapterEncapsulatedPacketTaskOffload [-Name] <String[]> [-IncludeHidden]
  [-NoRestart] [-PassThru] [-EncapsulationType <EncapsulationType>] [-CimSession <CimSession[]>]
  [-ThrottleLimit <Int32>] [-AsJob] [-WhatIf] [-Confirm] [<CommonParameters>]
- Enable-NetAdapterEncapsulatedPacketTaskOffload -InterfaceDescription <String[]>
  [-IncludeHidden] [-NoRestart] [-PassThru] [-EncapsulationType <EncapsulationType>]
  [-CimSession <CimSession[]>] [-ThrottleLimit <Int32>] [-AsJob] [-WhatIf] [-Confirm]
  [<CommonParameters>]
- Enable-NetAdapterEncapsulatedPacketTaskOffload -InputObject <CimInstance[]> [-NoRestart]
