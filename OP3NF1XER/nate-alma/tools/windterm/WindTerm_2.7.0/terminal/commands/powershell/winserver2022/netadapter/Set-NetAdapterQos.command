description: Sets QoS properties on a network adapter
synopses:
...
- Set-NetAdapterQos -InterfaceDescription <String[]> [-IncludeHidden] [-Enabled <Boolean>]
  [-NoRestart] [-CimSession <CimSession[]>] [-ThrottleLimit <Int32>] [-AsJob] [-PassThru]
  [-WhatIf] [-Confirm] [<CommonParameters>]
- Set-NetAdapterQos -InputObject <CimInstance[]> [-Enabled <Boolean>] [-NoRestart]
  [-CimSession <CimSession[]>] [-ThrottleLimit <Int32>] [-AsJob] [-PassThru] [-WhatIf]
  [-Confirm] [<CommonParameters>]
options:
  -AsJob Switch: ~
