description: This cmdlet adds a new service insertion resource to the Network Controller
synopses:
- New-NetworkControllerServiceInsertion [-ResourceId] <String> [[-Tags] <PSObject>]
  [-Properties] <ServiceInsertionProperties> [[-Etag] <String>] [[-ResourceMetadata]
...
options:
  ...
  -Properties ServiceInsertionProperties:
    required: true
  -ResourceId string:
    required: true
