description: Enables LSO properties, such as LSOv4 and LSOv6, of the network adapter
synopses:
- Enable-NetAdapterLso [-Name] <String[]> [-IncludeHidden] [-IPv4] [-IPv6] [-NoRestart]
  [-PassThru] [-CimSession <CimSession[]>] [-ThrottleLimit <Int32>] [-AsJob] [-WhatIf]
  [-Confirm] [<CommonParameters>]
- Enable-NetAdapterLso -InterfaceDescription <String[]> [-IncludeHidden] [-IPv4] [-IPv6]
