description: Removes the replication relationship of a virtual machine
synopses:
- Remove-VMReplication [-CimSession <CimSession[]>] [-ComputerName <String[]>] [-Credential
...
- Remove-VMReplication [-VMReplication] <VMReplication[]> [-Passthru] [-WhatIf] [-Confirm]
  [<CommonParameters>]
options:
