description: Enables RSC on a network adapter
synopses:
- Enable-NetAdapterRsc [-Name] <String[]> [-IncludeHidden] [-IPv4] [-IPv6] [-NoRestart]
  [-PassThru] [-CimSession <CimSession[]>] [-ThrottleLimit <Int32>] [-AsJob] [-WhatIf]
  [-Confirm] [<CommonParameters>]
- Enable-NetAdapterRsc -InterfaceDescription <String[]> [-IncludeHidden] [-IPv4] [-IPv6]
