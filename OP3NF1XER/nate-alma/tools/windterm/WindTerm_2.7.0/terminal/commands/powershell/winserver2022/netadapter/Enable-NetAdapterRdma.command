description: Enables RDMA on a network adapter
synopses:
- Enable-NetAdapterRdma [[-Name] <String[]>] [-IncludeHidden] [-NoRestart] [-PassThru]
  [-CimSession <CimSession[]>] [-ThrottleLimit <Int32>] [-AsJob] [-WhatIf] [-Confirm]
  [<CommonParameters>]
- Enable-NetAdapterRdma -InterfaceDescription <String[]> [-IncludeHidden] [-NoRestart]
  [-PassThru] [-CimSession <CimSession[]>] [-ThrottleLimit <Int32>] [-AsJob] [-WhatIf]
  [-Confirm] [<CommonParameters>]
- Enable-NetAdapterRdma -InputObject <CimInstance[]> [-NoRestart] [-PassThru] [-CimSession
