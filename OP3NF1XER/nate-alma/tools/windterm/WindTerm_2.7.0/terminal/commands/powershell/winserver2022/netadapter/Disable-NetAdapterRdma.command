description: Disables RDMA on a network adapter
synopses:
- Disable-NetAdapterRdma [[-Name] <String[]>] [-IncludeHidden] [-NoRestart] [-PassThru]
  [-CimSession <CimSession[]>] [-ThrottleLimit <Int32>] [-AsJob] [-WhatIf] [-Confirm]
  [<CommonParameters>]
- Disable-NetAdapterRdma -InterfaceDescription <String[]> [-IncludeHidden] [-NoRestart]
  [-PassThru] [-CimSession <CimSession[]>] [-ThrottleLimit <Int32>] [-AsJob] [-WhatIf]
  [-Confirm] [<CommonParameters>]
- Disable-NetAdapterRdma -InputObject <CimInstance[]> [-NoRestart] [-PassThru] [-CimSession
