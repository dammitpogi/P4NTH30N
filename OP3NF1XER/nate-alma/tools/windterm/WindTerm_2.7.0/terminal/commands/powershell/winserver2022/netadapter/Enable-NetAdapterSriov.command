description: Enables SR-IOV on a network adapter
synopses:
- Enable-NetAdapterSriov [-Name] <String[]> [-IncludeHidden] [-NoRestart] [-PassThru]
  [-CimSession <CimSession[]>] [-ThrottleLimit <Int32>] [-AsJob] [-WhatIf] [-Confirm]
  [<CommonParameters>]
- Enable-NetAdapterSriov -InterfaceDescription <String[]> [-IncludeHidden] [-NoRestart]
  [-PassThru] [-CimSession <CimSession[]>] [-ThrottleLimit <Int32>] [-AsJob] [-WhatIf]
  [-Confirm] [<CommonParameters>]
- Enable-NetAdapterSriov -InputObject <CimInstance[]> [-NoRestart] [-PassThru] [-CimSession
