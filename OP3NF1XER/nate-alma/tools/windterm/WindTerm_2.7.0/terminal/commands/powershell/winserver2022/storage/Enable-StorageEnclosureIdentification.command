description: Enables the identification LED on a storage enclosure or the slots for
  individual disks
synopses:
...
- Enable-StorageEnclosureIdentification -UniqueId <String[]> [-SlotNumbers <UInt32[]>]
  [-CimSession <CimSession[]>] [-ThrottleLimit <Int32>] [-AsJob] [-PassThru] [<CommonParameters>]
- Enable-StorageEnclosureIdentification -InputObject <CimInstance[]> [-SlotNumbers
