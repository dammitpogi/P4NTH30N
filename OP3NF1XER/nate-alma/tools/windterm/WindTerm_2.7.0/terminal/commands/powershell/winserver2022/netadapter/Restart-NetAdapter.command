description: Restarts a network adapter by disabling and then re-enabling the network
  adapter
synopses:
- Restart-NetAdapter [-Name] <String[]> [-IncludeHidden] [-PassThru] [-CimSession
  <CimSession[]>] [-ThrottleLimit <Int32>] [-AsJob] [-WhatIf] [-Confirm] [<CommonParameters>]
- Restart-NetAdapter -InterfaceDescription <String[]> [-IncludeHidden] [-PassThru]
