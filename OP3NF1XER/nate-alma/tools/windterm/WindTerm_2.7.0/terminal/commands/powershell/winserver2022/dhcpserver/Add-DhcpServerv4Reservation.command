description: Reserves an IPv4 address in the scope for a client
synopses:
- Add-DhcpServerv4Reservation [-ComputerName <String>] [-ScopeId] <IPAddress> [-IPAddress]
  <IPAddress> [-ClientId] <String> [-Name <String>] [-Description <String>] [-Type
