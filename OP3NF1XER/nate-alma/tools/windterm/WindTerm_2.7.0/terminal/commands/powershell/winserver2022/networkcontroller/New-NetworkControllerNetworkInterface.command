description: This cmdlet adds a new network interface resource to the Network Controller
synopses:
- New-NetworkControllerNetworkInterface [-ResourceId] <String> [[-Tags] <PSObject>]
  [-Properties] <NetworkInterfaceProperties> [[-Etag] <String>] [[-ResourceMetadata]
