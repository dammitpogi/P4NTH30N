...
{
    public static double DefaultThreshold(this JackpotTier tier) => tier switch
    {
    ...
    public static double Capacity(this JackpotTier tier) => tier switch
    {
    ...
    public static JackpotTier FromString(string category) => category.ToUpperInvariant() switch
    {
