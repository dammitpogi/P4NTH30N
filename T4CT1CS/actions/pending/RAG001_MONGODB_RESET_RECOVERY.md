...
Move-Item "C:\ProgramData\P4NTH30N\rag-index\faiss.index" "C:\ProgramData\P4NTH30N\rag-index\faiss.index.backup.$(Get-Date -Format 'yyyyMMdd_HHmmss')"
Move-Item "C:\ProgramData\P4NTH30N\rag-index\metadata.db" "C:\ProgramData\P4NTH30N\rag-index\metadata.db.backup.$(Get-Date -Format 'yyyyMMdd_HHmmss')"

# Or delete entirely for clean rebuild:
Remove-Item "C:\ProgramData\P4NTH30N\rag-index\*" -Recurse -Force
New-Item -ItemType Directory -Force -Path "C:\ProgramData\P4NTH30N\rag-index"
```
...
Start-Process python -ArgumentList "C:\P4NTH30N\src\RAG\PythonBridge\embedding_bridge.py" -WindowStyle Hidden
...
C:\ProgramData\P4NTH30N\bin\RAG.McpHost.exe --rebuild full
```
...
foreach ($doc in $docs) {
    $relativePath = $doc.FullName.Replace("C:\P4NTH30N\", "")
...
Copy-Item "C:\ProgramData\P4NTH30N\rag-index" "C:\Backups\rag-index-$(Get-Date -Format 'yyyyMMdd')" -Recurse
```
