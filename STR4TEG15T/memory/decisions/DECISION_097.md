...
status: active
version: 1.0.0
created_at: '2026-02-23T01:31:15.809Z'
last_reviewed: '2026-02-23T01:31:15.809Z'
keywords:
  - decision097
  - rag
  - migration
...
roles:
  ...
  - oracle
summary: >-
  Migrate all vector data and ingestion configurations from the legacy RAG
  system (RAG.McpHost.exe on port 5001 with FAISS in-memory index) to the new
  RAG v2 server (Docker-based with ChromaDB vector store). This migration
  consolidates the RAG infrastructure onto the modern v2 architecture built in
  DECISION_096, eliminating the legacy system and its associated maintenance
  burden. **Result**: ✅ Successfully migrated 4,455 legacy vectors → 7,421 RAG
  v2 vectors ---
source:
  type: decision
  original_path: ../../../STR4TEG15T/decisions/completed/DECISION_097.md
---
