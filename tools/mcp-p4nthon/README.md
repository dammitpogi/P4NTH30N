...
Model Context Protocol (MCP) server for P4NTHE0N casino automation platform.

## Overview

This MCP server provides AI assistants with direct access to P4NTHE0N's MongoDB data, enabling:
