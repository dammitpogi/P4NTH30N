...
Deep dives into H0UND, H4ND, W4TCHD0G, and C0MMON.

### 🚀 [Deployment](deployment/)
Deployment methods, checklists, and procedures.

### 📋 [Operations](operations/)
Runbooks, procedures, and monitoring.

### 🛡️ [Security](security/)
Security policies, hardening, and compliance.

### 📈 [Strategy](strategy/)
Threshold calibration, game selection, and performance.

### 🔬 [Reference](reference/)
Technical specifications and troubleshooting.

### 📜 [Project](project/)
Changelog, roadmap, and contribution guidelines.

## 🆘 Need Help?

- **Emergency**: [Emergency Response](operations/procedures/EMERGENCY_RESPONSE.md)
- **Issues**: [Troubleshooting](operations/runbooks/TROUBLESHOOTING.md)
- **Incidents**: [Incident Response](operations/runbooks/INCIDENT_RESPONSE.md)

## 📖 Key Documents by Decision

| Decision | Document |
|----------|----------|
| CORE-001 | [Core Systems Architecture](architecture/decisions/ADR-001-Core-Systems.md) |
| INFRA-005 | [Disaster Recovery](operations/procedures/DISASTER_RECOVERY.md) |
| INFRA-006 | [Security Hardening](security/SECURITY.md) |
| WIN-001 | [Testing Guide](development/testing/) |
| WIN-002 | [Emergency Response](operations/procedures/EMERGENCY_RESPONSE.md) |
| WIN-005 | [Casino Setup](security/credentials/CASINO_SETUP.md) |
| WIN-006 | [Threshold Calibration](strategy/THRESHOLD_CALIBRATION.md) |
| WIN-007 | [First Jackpot Attempt](operations/procedures/FIRST_JACKPOT_ATTEMPT.md) |
| WIN-008 | [Go-Live Checklist](deployment/GOLIVE_CHECKLIST.md) |

## 🔄 Document Status

| Category | Status | Coverage |
|----------|--------|----------|
| Getting Started | 🟡 In Progress | Quickstart needed |
| Architecture | 🟢 Complete | All decisions documented |
| API Reference | 🔴 Missing | Need interface docs |
| Data Models | 🔴 Missing | Need schema docs |
| Components | 🟡 Partial | W4TCHD0G documented |
| Operations | 🟢 Complete | All runbooks present |
...
**Contributing**: See [Documentation Guide](development/contributing/documentation.md)
