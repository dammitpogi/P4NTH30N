...
namespace P4NTH30N.PROF3T
{
    public class AutomationEngine : IAutomationEngine
    {
        ...
        public ComplexityLevel ClassifyComplexity(string decisionId)
        {
            ...
            if (decisionId.Contains("Critical")) return ComplexityLevel.Critical;
            if (decisionId.Length > 50) return ComplexityLevel.Large;
            if (decisionId.Length > 25) return ComplexityLevel.Medium;
