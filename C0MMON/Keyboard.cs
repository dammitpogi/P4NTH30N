...
public class Keyboard
{
	...
	{
		new InputSimulator().Keyboard.ModifiedKeyStroke([VirtualKeyCode.CONTROL, VirtualKeyCode.SHIFT], VirtualKeyCode.VK_D);
		Thread.Sleep(400);
		return new Keyboard();
	}
	...
	{
		new InputSimulator().Keyboard.ModifiedKeyStroke([VirtualKeyCode.LMENU], VirtualKeyCode.TAB);
		Thread.Sleep(400);
		return new Keyboard();
	}
	...
	{
		new InputSimulator().Keyboard.ModifiedKeyStroke([VirtualKeyCode.LCONTROL, VirtualKeyCode.LSHIFT], VirtualKeyCode.VK_I);
		Thread.Sleep(400);
		return new Keyboard();
	}
	...
	{
		new InputSimulator().Keyboard.ModifiedKeyStroke([VirtualKeyCode.LWIN], VirtualKeyCode.SNAPSHOT);
		return new Keyboard();
	}
