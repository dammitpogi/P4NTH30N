...
public static class Dashboard
{
	...
	public static void Render()
	{
		...
		{
			table.AddRow($"[grey]{evt.Time:HH:mm:ss}[/]", $"[{evt.Style}]{evt.Message.Replace("[", "[[").Replace("]", "]]")}[/]");
		}

		AnsiConsole.Write(new Spectre.Console.Panel(table).Border(BoxBorder.Double).Header("Event Log").Expand());
