import { executeMongoTool, mongoTools } from '../tools/index.js';
...
export async function handleMcpMessage(
  ...
  switch (request.method) {
    ...
    case 'tools/call': {
      ...
      try {
        const result = await executeMongoTool(params.name, params.arguments ?? {});
        return {
          jsonrpc: '2.0',
          id: request.id,
          result: {
