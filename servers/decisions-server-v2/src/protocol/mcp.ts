import { executeDecisionTool, decisionTools } from '../tools/index.js';
...
export async function handleMcpMessage(
  ...
  switch (request.method) {
    ...
    case 'tools/call': {
      ...
      try {
        const result = await executeDecisionTool(params.name, params.arguments ?? {});
        return {
          jsonrpc: '2.0',
          id: request.id,
          result: {
