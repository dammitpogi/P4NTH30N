...
async function main() {
  ...
  const result = await client.callTool('rag_search', {
    query: 'DECISION_096 Week 4 integration deployment ToolHive config patterns',
    topK: 3,
  });
...
class McpClient {
  ...
  async initialize() {
    await this.sendRequest('initialize', {
      ...
      capabilities: {},
      clientInfo: { name: 'rag-week4-query', version: '1.0.0' },
    });
