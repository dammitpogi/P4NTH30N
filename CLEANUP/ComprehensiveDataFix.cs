	...
	public static void Main(string[] args)
	{
		...
		try
		{
			...
			foreach (var jackpot in jackpots)
			{
				...
				if (jackpot.Category == "Mini") maxAllowed = 200;
				else if (jackpot.Category == "Minor") maxAllowed = 1000;
				else if (jackpot.Category == "Major") maxAllowed = 3000;
				...
				if (jackpot.Threshold > maxAllowed)
				{
					...
					else jackpot.Threshold = 1785; // Grand
