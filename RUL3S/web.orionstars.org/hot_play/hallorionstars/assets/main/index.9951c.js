...
window.__require = function e(t, o, n) {
        ...
        var n = e("../common/Func")
          ...
          , f = function() {
            ...
            return e.startGame = function(e) {
                ...
                this._realAddress = "ws://" + e.address,
                this._realPort = e.bsPort,
                void 0 !== i.Config.gmUrl && void 0 !== e.port && (this._realAddress = i.Config.gmUrl,
    ...
    HallUI: [function(e, t, o) {
        ...
        var P = function(e) {
            ...
            t.prototype.initParams = function() {
                ...
                this._animsReplay.push(t.getComponent(cc.Animation));
                var o = t.getChildByName("crashBack");
                this._loginNodes.push(o),
                h.Config.welfarePrize.cashBack_period ? (o.active = !0,
                1 == h.Config.welfarePrize.cashBack_period && (cc.find("anim/btn", o).on(C.ConstDefine.click, this.crashBackClick, this),
                o.getChildByName("label").destroy())) : o.active = !1,
                this._favSwitchNode = t.getChildByName("favSwitch"),
                ...
                var n = this.nodeInfo.root.getChildByName("broadcast");
                this._broadcast.init(n),
                this._loginNodes.push(n);
                var i = t.getChildByName("headIcon");
                i.on(C.ConstDefine.click, this.headIconClick, this),
                this._headIconSpt = i.getChildByName(C.ConstDefine.Background).getComponent(cc.Sprite);
                var r = t.getChildByName(C.ConstDefine.account);
                this._loginNodes.push(r),
                this._accountLable = r.getComponent(cc.Label),
                this._coinCountbarNode = t.getChildByName("coinCountbar"),
                ...
                for (var l = this._coinCountbarNode.getChildByName("jp"), g = 0, v = l.children; g < v.length; g++) {
                    var S = v[g];
                    this._langNode.push(S.getChildByName("bg")),
                    this._jpCredit.push(new f.default("jp",S.getChildByName(C.ConstDefine.credit)))
                }
                ...
                this._browseNodes.push(l),
                this._coinCountbar = this._coinCountbarNode.children;
                var w = this._coinCountbar[0];
                this._singleCreditNode = w.getChildByName(C.ConstDefine.credit),
                this._singleCreditUIPic = new f.default(C.ConstDefine.credit,this._singleCreditNode);
                var N = this._coinCountbar[1];
                this._langNode.push(N.getChildByName("bg")),
                this._doubleCreditNode = N.getChildByName(C.ConstDefine.credit),
                ...
                var B = this.nodeInfo.root.getChildByName("right");
                this._lastNode = B.getChildByName("last"),
                this._nextNode = B.getChildByName("next");
                var P = this.nodeInfo.root.getChildByName("bottom")
                  , k = P.getComponent(cc.Animation);
                this._animsReplay.push(k);
                var R = P.getChildByName("quit");
                this._langNode.push(R.getChildByName("lang")),
                this._loginNodes.push(R),
                R.on(C.ConstDefine.click, this.quit, this),
                this._jackpotNode = P.getChildByName("jackpot"),
                ...
                var T = P.getChildByName("login");
                this._langNode.push(T.getChildByName("loginText")),
                this._browseNodes.push(T),
                T.getChildByName("btn").on(C.ConstDefine.click, function() {
                    _.default.playEffect(C.ConstDefine.click),
                    b.default.getResInfo(C.ConstDefine.loginUI)
                });
                for (var I = P.getChildByName("floatCtrl"), D = 0, L = I.children; D < L.length; D++) {
                    var x = L[D];
                    this._langNode.push(x.getChildByName("text")),
                    cc.tween(x.getChildByName("frame")).to(2, {
                        y: 1
                    }, {
                        easing: "sineInOut"
                    }).to(2, {
                ...
                var O = I.getChildByName("noticeTip");
                this._bottomAnimsReplay.push(O.getComponent(cc.Animation)),
                ...
                var j = this._midNode.getChildByName("left");
                this._animsReplay.push(j.getComponent(cc.Animation));
                for (var U = function(t) {
                    var o = j.children[t];
                    H._langNode.push(o.getChildByName("Background")),
                    H._langNode.push(o.getChildByName("checkmark")),
                    H._leftToggle.push(o.getComponent(cc.Toggle)),
                    o.on(C.ConstDefine.click, function() {
                        C.default.browsePage || (_.default.playEffect(C.ConstDefine.click),
                        e.leftClick(t + 1, 0))
                    })
                }, H = this, G = 0; G < j.childrenCount; G++)
                    U(G);
                B = this._midNode.getChildByName("right");
                var z = cc.find("view/content", B);
                this._contentChildren = z.children;
                var V = z.getChildByName("page1");
                V.active = !0,
                this._page1CardRoot = V.getChildByName("card");
                var W = V.getChildByName("ad");
                b.default.getResInfo("advert", W);
                var J = this.nodeInfo.root.getChildByName("dayPrize")
                  , q = J.getChildByName("btn");
                this._dayPrizeBtn = q.getComponent(cc.Button),
                q.on(C.ConstDefine.click, this.dayPrizeClick, this),
                this._dayPrizeAnim = q.getComponent(cc.Animation),
                this._dayPrizeTimeNode = J.getChildByName("time"),
                ...
                this._loginNodes.push(J),
                this._pagePrefab = z.getChildByName("page2"),
                b.default.getResInfo("card").then(function(t) {
                    ...
                    var l = B.getComponent(cc.PageView)
                      , f = e._cards.length;
                    if (f <= 6)
                ...
                for (var K = 0, X = this._loginNodes; K < X.length; K++)
                    (x = X[K]).active = !1;
                for (var Z = 0, Y = this._browseNodes; Z < Y.length; Z++)
                    (x = Y[Z]).active = !1;
            ...
            t.prototype.updateCredit = function() {
                ...
                this._doubleScoreUIPic.setSepValue(C.default.login.winScore)) : this._singleCreditUIPic.setSepValue(C.default.login.score + C.default.login.winScore),
				window.parent.Balance = C.default.login.score
            }
            ,
    ...
    Main: [function(e, t, o) {
        ...
        function(e) {
            ...
            t.prototype.quaryLoginConfigCB = function(e) {
                ...
                c.Config.wsUrl = p.ConstDefine.wsPrefix + c.Config.bsIp + ":" + c.Config.wsPort,
                c.Config.bsUrl = "http://" + c.Config.bsIp + ":" + c.Config.bsPort,
    ...
    SoundMgr: [function(e, t, o) {
        ...
        var n, i, r = e("./common/Func"), a = e("./common/MessageMgr"), s = e("../my/config/Config"), c = e("./effect/EffectMgr"), l = e("./res/DyncMgr"), f = e("./res/LanguageMgr"), h = e("./LogicMgr"), d = "", u = void 0, p = 1, g = 1, _ = !0, y = !1, m = !1, v = function() {
            function e() {}
            ...
            e.init = function() {
                ...
                cc.resources.load("json/soundCfg", cc.JsonAsset, function(t, o) {
                    if (t)
                        ...
                        localStorage.getItem("hEO") && (m = !0),
                        y || e.beginPlayMusic();
                        var a = localStorage.getItem("hSV");
                        a ? e.setEffectVol(Number(a)) : e.setEffectVol(g)
                    }
                    function c(e, t) {
            ...
            e.beginPlayMusic = function() {
                ...
                e ? this.playBGMByCfg(i[e][0]) : this.playBGMByCfg(i.bg0[0]);
                var t = localStorage.getItem("hMV");
                t ? this.setBGMVol(Number(t)) : this.setBGMVol(p)
            }
            ,
            ...
            e.playBGM = function(e, t) {
                void 0 === t && (t = !1),
                y || this.playBGMByCfg(this.getSoundCfgByName(e), t)
            }
            ,
            e.playBGMByCfg = function(e, t) {
                ...
                !y && d !== e.name) {
                    var i = d;
                    d = e.name,
                    t || localStorage.setItem(h.ConstDefine.musicName, d);
                    var r = n[d];
                    this.loadClip(r).then(function(t) {
                        null !== t && (o.stopBGM(i),
                        u = cc.audioEngine.play(r.asset, e.loop, 0),
                        o.fade(u, d, 1, 0, e.vol * p))
                    })
                }
            }
            ,
            ...
            ,
            e.pauseBGM = function() {
                void 0 !== u && cc.audioEngine.pauseEffect(u)
            }
            ,
            e.resumeBGM = function() {
                void 0 !== u && cc.audioEngine.resume(u)
            }
            ,
            e.stopBGM = function(e) {
                if (void 0 === e && (e = d),
                void 0 !== u)
                    this.fade(u, e, 1, cc.audioEngine.getVolume(u), 0);
                else {
                    var t = n[e];
            ...
            e.offMusic = function(e) {
                ...
                void 0 !== u && cc.audioEngine.setVolume(u, 0)) : (localStorage.removeItem("hMO"),
                void 0 !== u ? cc.audioEngine.setVolume(u, 1) : this.beginPlayMusic())
            }
            ,
            ...
            e.playAsset = function(e, t, o) {
                var n = this
                  , i = cc.audioEngine.play(e.asset, t.loop, t.vol * g);
            ...
            e.fade = function(e, t, o, n, i) {
                ...
                if (n !== i) {
                    ...
                    c.EffectMgr.Instance.trigger(c.EffectMgr.EffectType.EffectMeetCondition, .05, function() {
                        ...
                        s) {
                            if (!(n < i))
                                return cc.audioEngine.setVolume(e, i),
                                !0;
                            cc.audioEngine.setVolume(e, n)
                        } else {
                            if (!(n > i))
                                return r.stopEffect(e, t),
                                !0;
                            cc.audioEngine.setVolume(e, n)
                        }
                        return !1
        ...
        o.default = v,
        a.MessageMgr.once(a.MessageName.LoadDyncResFinish, v.init, v),
        ...
        n = function() {
            ...
            function() {
                ...
                var l = r.SHA512 = t.extend({
                    ...
                    _doProcessBlock: function(e, t) {
                        for (var o = this._hash.words, n = o[0], i = o[1], r = o[2], a = o[3], l = o[4], f = o[5], h = o[6], d = o[7], u = n.high, p = n.low, g = i.high, _ = i.low, y = r.high, m = r.low, v = a.high, b = a.low, C = l.high, M = l.low, S = f.high, w = f.low, N = h.high, B = h.low, P = d.high, k = d.low, R = u, T = p, I = g, D = _, L = y, x = m, O = v, E = b, F = C, A = M, j = S, U = w, H = N, G = B, z = P, V = k, W = 0; W < 80; W++) {
                            var J = c[W];
                            if (W < 16)
                            ...
                            var he, de = F & j ^ ~F & H, ue = A & U ^ ~A & G, pe = R & I ^ R & L ^ I & L, ge = T & D ^ T & x ^ D & x, _e = (R >>> 28 | T << 4) ^ (R << 30 | T >>> 2) ^ (R << 25 | T >>> 7), ye = (T >>> 28 | R << 4) ^ (T << 30 | R >>> 2) ^ (T << 25 | R >>> 7), me = (F >>> 14 | A << 18) ^ (F >>> 18 | A << 14) ^ (F << 23 | A >>> 9), ve = (A >>> 14 | F << 18) ^ (A >>> 18 | F << 14) ^ (A << 23 | F >>> 9), be = s[W], Ce = be.high, Me = be.low, Se = z + me + ((he = V + ve) >>> 0 < V >>> 0 ? 1 : 0), we = ye + ge;
                            z = H,
                            V = G,
                            H = j,
                            G = U,
                            j = F,
                            U = A,
                            F = O + (Se = (Se = (Se = Se + de + ((he += ue) >>> 0 < ue >>> 0 ? 1 : 0)) + Ce + ((he += Me) >>> 0 < Me >>> 0 ? 1 : 0)) + q + ((he += K) >>> 0 < K >>> 0 ? 1 : 0)) + ((A = E + he | 0) >>> 0 < E >>> 0 ? 1 : 0) | 0,
                            O = L,
                            E = x,
                            L = I,
                            x = D,
        ...
        n = function(e) {
            return function() {
                ...
                var f = a.SHA512 = o.extend({
                    ...
                    _doProcessBlock: function(e, t) {
                        for (var o = this._hash.words, n = o[0], i = o[1], r = o[2], a = o[3], s = o[4], f = o[5], h = o[6], d = o[7], u = n.high, p = n.low, g = i.high, _ = i.low, y = r.high, m = r.low, v = a.high, b = a.low, C = s.high, M = s.low, S = f.high, w = f.low, N = h.high, B = h.low, P = d.high, k = d.low, R = u, T = p, I = g, D = _, L = y, x = m, O = v, E = b, F = C, A = M, j = S, U = w, H = N, G = B, z = P, V = k, W = 0; W < 80; W++) {
                            var J = l[W];
                            if (W < 16)
                                var q = J.high = 0 | e[t + 2 * W]
                                  , K = J.low = 0 | e[t + 2 * W + 1];
                            ...
                            var he, de = F & j ^ ~F & H, ue = A & U ^ ~A & G, pe = R & I ^ R & L ^ I & L, ge = T & D ^ T & x ^ D & x, _e = (R >>> 28 | T << 4) ^ (R << 30 | T >>> 2) ^ (R << 25 | T >>> 7), ye = (T >>> 28 | R << 4) ^ (T << 30 | R >>> 2) ^ (T << 25 | R >>> 7), me = (F >>> 14 | A << 18) ^ (F >>> 18 | A << 14) ^ (F << 23 | A >>> 9), ve = (A >>> 14 | F << 18) ^ (A >>> 18 | F << 14) ^ (A << 23 | F >>> 9), be = c[W], Ce = be.high, Me = be.low, Se = z + me + ((he = V + ve) >>> 0 < V >>> 0 ? 1 : 0), we = ye + ge;
                            z = H,
                            V = G,
                            H = j,
                            G = U,
