...
### One-Step Deployment (Recommended for VMWare/New Systems)

This method installs OpenCode, the plugin, and **all current configurations** (prompts, model chains, skills) in one step.

**Linux/macOS:**
```bash
curl -fsSL https://raw.githubusercontent.com/dammitpogi/oh-my-opencode-theseus/master/install.sh | bash
```

**Windows (PowerShell):**
```powershell
irm https://raw.githubusercontent.com/dammitpogi/oh-my-opencode-theseus/master/install.ps1 | iex
```
...
> **💡 Models are fully customizable.** Edit `~/.config/opencode/oh-my-opencode-theseus.json` (or `.jsonc` for comments support) to assign any model to any agent.

### For LLM Agents

If you are an LLM agent helping a user install this plugin, please refer to the **[Agent Installation Guide](agent_install.md)** for a streamlined setup process.

Alternatively, you can paste this into any coding agent:
...
<table>
  ...
  <tr>
    <td colspan="2">
      <b>Prompt:</b> <code>~/.config/opencode/agents/orchestrator.md</code>
    </td>
  </tr>
  <tr>
    <td colspan="2">
...
<table>
  ...
  <tr>
    <td colspan="2">
      <b>Prompt:</b> <code>~/.config/opencode/agents/explorer.md</code>
    </td>
  </tr>
  <tr>
    <td colspan="2">
...
<table>
  ...
  <tr>
    <td colspan="2">
      <b>Prompt:</b> <code>~/.config/opencode/agents/oracle.md</code>
    </td>
  </tr>
  <tr>
    <td colspan="2">
...
<table>
  ...
  <tr>
    <td colspan="2">
      <b>Prompt:</b> <code>~/.config/opencode/agents/librarian.md</code>
    </td>
  </tr>
  <tr>
    <td colspan="2">
...
<table>
  ...
  <tr>
    <td colspan="2">
      <b>Prompt:</b> <code>~/.config/opencode/agents/designer.md</code>
    </td>
  </tr>
  <tr>
    <td colspan="2">
...
<table>
  ...
  <tr>
    <td colspan="2">
      <b>Prompt:</b> <code>~/.config/opencode/agents/fixer.md</code>
    </td>
  </tr>
  <tr>
    <td colspan="2">
