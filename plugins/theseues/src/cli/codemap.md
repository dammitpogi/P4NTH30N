...
The `src/cli/` directory provides the command-line interface for installing and configuring **oh-my-opencode-theseus**, an OpenCode plugin. It handles:
...
```
User runs: bunx oh-my-opencode-theseus install
         │
         ▼
┌─────────────────────────────────────────┐
│ index.ts: parseArgs()                   │
...
└─────────────────┬───────────────────────┘
                  ...
                  ▼
┌─────────────────────────────────────────┐
│ Parse oh-my-opencode-theseus.json          │
│ - Extract preset name                   │
...
| `oh-my-opencode-theseus.json` | `~/.config/opencode/` | Plugin-specific config |

### Consumers

1. **End Users**: Via `bunx oh-my-opencode-theseus install`
