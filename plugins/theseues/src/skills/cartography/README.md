...
2. Creating `.theseues/cartography.json` for change tracking
...
Installed automatically via oh-my-opencode-theseus installer when custom skills are enabled.
