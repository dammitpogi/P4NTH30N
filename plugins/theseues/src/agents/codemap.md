...
**Custom Prompts**
- Handled by OpenCode core from agents directory
- Plugin does not manage prompts
...
| Librarian | External docs | Available MCPs | Evidence-based | 0.1 |
...
- MCP tools enable agent capabilities
