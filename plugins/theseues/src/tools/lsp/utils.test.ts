...
function makeFileUri(filename: string): string {
  return pathToFileURL(resolve(filename)).toString();
}
...
describe('utils', () => {
  ...
  describe('applyWorkspaceEdit', () => {
    ...
    test('should handle create file operation', () => {
      const newUri = makeFileUri('new.ts');
      const edit = {
        documentChanges: [{ kind: 'create', uri: newUri }],
      };
    ...
    test('should handle rename file operation', () => {
      const oldUri = makeFileUri('old.ts');
      const newUri = makeFileUri('new.ts');
    ...
    test('should handle delete file operation', () => {
      const uri = makeFileUri('delete.ts');
      const edit = {
