...
**oh-my-opencode-theseus** is a lightweight agent orchestration plugin for OpenCode - a evolved fork of oh-my-opencode. It provides a multi-agent system that enables specialized AI agents to work together under an orchestrator to optimize coding tasks for quality, speed, cost, and reliability.
...
|------|---------|-------------|
| `package.json` | Project manifest, dependencies, and build scripts | `oh-my-opencode-theseus` CLI, `dist/index.js` main entry |
