...
function getInstallDir(): string {
  ...
  return join(homeDir, '.cache', 'oh-my-opencode-theseus', 'bin');
}
...
export async function downloadAndInstallRipgrep(): Promise<string> {
  ...
  try {
    console.log(`[oh-my-opencode-theseus] Downloading ripgrep...`);
    ...
    console.log(`[oh-my-opencode-theseus] ripgrep ready.`);
    return rgPath;
  } finally {
