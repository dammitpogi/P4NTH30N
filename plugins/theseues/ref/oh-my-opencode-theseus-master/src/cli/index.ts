...
function printHelp(): void {
  console.log(`
oh-my-opencode-theseus installer

Usage: bunx oh-my-opencode-theseus install [OPTIONS]
       bunx oh-my-opencode-theseus models [OPTIONS]
...
Examples:
  ...
  bunx oh-my-opencode-theseus models
  bunx oh-my-opencode-theseus install --no-tui --kimi=yes --openai=yes --anthropic=yes --copilot=no --zai-plan=no --antigravity=yes --chutes=no --opencode-free=yes --balanced-spend=yes --opencode-free-model=auto --aa-key=YOUR_AA_KEY --openrouter-key=YOUR_OR_KEY --tmux=no --skills=yes
`);
}
