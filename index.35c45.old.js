// http://web.orionstars.org/hot_play/hallorionstars/assets/main/index.35c45.js
...
window.__require = function e(t, o, n) {
        ...
        var r = e("../../base/common/MessageMgr")
          ...
          , p = function(e) {
            ...
            t.prototype.resetParams = function(e) {
                this._adRoot = e,
                d.default.login.succeed ? this.loginSucceeded() : r.MessageMgr.once(r.MessageName.LoginSucceeded, this.loginSucceeded, this)
            }
            ,
            t.prototype.loginSucceeded = function() {
                ...
                for (var o = [], n = function(e) {
                    ...
                    o.push(n),
                    n.on(d.ConstDefine.click, function() {
                        t.pgClick(e)
                    })
                }, i = this, a = 0; a < d.default.login.guangGao.length; a++)
                    n(a);
                ...
                (e = this._guanggao).push.apply(e, d.default.login.guangGao),
            ...
            t.prototype.pgClick = function(e) {
                c.default.playEffect(d.ConstDefine.click),
                h.default.getResInfo("bigAdvertUI", e)
            }
            ,
            t.prototype.changeLang = function() {
                for (var e = s.Config.configPath + "lang/" + u.default.currLang + "/advert/", t = e + "tag/", o = 0; o < this._guanggao.length; o++) {
                    var n = this._loopPgView.contents[o]
                      , i = this._guanggao[o]
                      , r = n.getChildByName(d.ConstDefine.Background).getComponent(cc.Sprite);
                    a.default.setRemoteSpt(e, d.ConstDefine.ad, i, r);
                    var c = d.default.kpKeyCfg[i];
                    if (c && void 0 !== c.t) {
                        var l = n.getChildByName("tag").getComponent(cc.Sprite);
                        a.default.setRemoteSpt(t, d.ConstDefine.tag, c.t, l)
                    }
                }
            }
            ,
        ...
        var r = e("../../base/common/view/PageView")
          ...
          , d = function(e) {
            ...
            t.prototype.initParams = function() {
                ...
                this._popupMethod.root.getChildByName(u.ConstDefine.close).on(u.ConstDefine.click, this.close, this);
                ...
                this._playNow.on(u.ConstDefine.click, this.playNowClick.bind(this)),
                this._pgNode = o.getChildByName("pageView");
                for (var l = this._pgNode.getComponent(cc.PageView), f = this._pgNode.getChildByName("prefab"), h = 0; h < u.default.login.guangGao.length; h++) {
                    var d = u.default.login.guangGao[h]
                      , p = cc.instantiate(f);
                    l.addPage(p),
                    a.default.setRemoteSpt(s.Config.configPath + "bigAdvertUI/", u.ConstDefine.bad, d, p.getComponent(cc.Sprite))
                }
                f.destroy(),
                this.showInfo(0),
                    ...
                    var o = {
                        ...
                        finishCall: function(e) {
                            ...
                            var o = e.pgView.content.children
                              , n = o[0]
                              , i = o[o.length - 1];
                            a.default.setRemoteSpt(s.Config.configPath + "bigAdvertUI/", u.ConstDefine.bad, u.default.login.guangGao[u.default.login.guangGao.length - 1], n.getComponent(cc.Sprite)),
                            a.default.setRemoteSpt(s.Config.configPath + "bigAdvertUI/", u.ConstDefine.bad, u.default.login.guangGao[0], i.getComponent(cc.Sprite))
                        },
            ...
            t.prototype.playNowClick = function() {
                l.default.playEffect(u.ConstDefine.click),
                c.default.startGame(this.getKpCfg())
            }
            ,
            t.prototype.getKpCfg = function() {
                var e = u.default.login.guangGao[this._lastIndex]
                  , t = u.default.kpKeyCfg[e];
                return void 0 === t && (t = u.default.bigGG[e]),
                t
            }
            ,
            t
        ...
        var r = e("../config/Config")
          ...
          , y = function(e) {
            ...
            t.prototype.initParams = function() {
                ...
                var u = this._popupMethod.root.getChildByName("btn_rules")
                  , g = o.generateAttachedNodes("tanhao");
                u.parent = g[0],
                u.setPosition(0, 0),
                u.on(c.ConstDefine.click, this.showInstructions, this),
                ...
                c.default.login.testAcccount ? _.on(c.ConstDefine.click, function() {
                    f.MessageMgr.emit(f.MessageName.NetMsg, {
                        mainID: d.Cmd.MDM_MB_LOGON,
                        subID: d.Cmd.SUB_GET_CASH_BACK_RESULT,
                        data: {
                            result: 0,
            ...
            t.prototype.netOpen = function() {
                ...
                u.NetMgr.send(d.Cmd.MDM_MB_LOGON, d.Cmd.SUB_GET_CASH_BACK, e)
            }
            ,
            ...
            t.prototype.onLogonNet = function(e) {
                if (e.mainID === d.Cmd.MDM_MB_LOGON && e.subID === d.Cmd.SUB_GET_CASH_BACK_RESULT)
    ...
    DyncInfo: [function(e, t, o) {
        ...
        function p(e, t) {
            return void 0 === e && (e = {}),
            e.class ? new d(e,t) : new u(e,t)
        }
        o.DyncInstanceInfo = d;
        var g = function() {
            function e() {}
    ...
    GTAssembler2D: [function(e, t, o) {
        ...
        var r = function(e) {
            ...
            t.prototype.fillBuffers = function(e, t) {
                ...
                for (var l = r._iData, f = a.indiceOffset, h = a.vertexOffset, u = 0, d = i.length; u < d; u++)
                    l[f++] = h + i[u]
            }
            ,
            ...
            t.prototype.updateUVs = function(t) {
                ...
                if (o.width && o.height && n.width && n.height) {
                    ...
                    r > a) {
                        var u = .5 * (c + l)
                          , d = .5 * (l - c) * (a / r);
                        c = i[0 + (p = s ? 1 : 0)] = i[4 + p] = u - d,
                        l = i[2 + p] = i[6 + p] = u + d
                    } else {
                        var p;
                        u = .5 * (f + h),
                        d = .5 * (f - h) * (r / a),
                        f = i[1 + (p = s ? -1 : 0)] = i[3 + p] = u + d,
                        h = i[5 + p] = i[7 + p] = u - d
                    }
            ...
            e.onMessage = function(e) {
                ...
                if (t.mainID == c.Cmd.MDM_GR_GAME && t.subID == c.Cmd.SUB_GR_GAME_PINGRESULT) {
                    if (0 == o.result) {
                        ...
                        u.length > 2083 && console.error("\u8fde\u63a5\u957f\u5ea6\u8d85\u8fc7\u4e862083\u5b57\u7b26"),
                        this._socket.close(),
                        location.href = u
                    } else
                        r.default.hide(l.ConstDefine.loadingTip),
    ...
    HallUI: [function(e, t, o) {
        ...
        var S, w = cc.v3(0, 320), N = cc.v3(0, 258), B = function() {
            ...
            e.prototype.clear = function() {
                ...
                u.EffectMgr.Instance.removeEffect(this._eff))
            }
            ,
            e.prototype.addMsg = function(e) {
                ...
                this._eff = u.EffectMgr.Instance.trigger(u.EffectMgr.EffectType.EffectMeetCondition, 1, this.updateMsg.bind(this), this.end.bind(this)))
            }
            ,
        ...
        var P = function(e) {
            ...
            t.prototype.initParams = function() {
                ...
                this._animsReplay.push(n.getComponent(cc.Animation)),
                t.push(n.getChildByName("shengdan"));
                var i = n.getChildByName("crashBack");
                this._loginNodes.push(i),
                h.Config.welfarePrize.cashBack_period ? (i.active = !0,
                1 == h.Config.welfarePrize.cashBack_period && (cc.find("anim/btn", i).on(C.ConstDefine.click, this.crashBackClick, this),
                i.getChildByName("label").destroy())) : i.active = !1,
                this._favSwitchNode = n.getChildByName("favSwitch"),
                ...
                var r = this.nodeInfo.root.getChildByName("broadcast");
                this._broadcast.init(r),
                this._loginNodes.push(r);
                var l = n.getChildByName("headIcon");
                l.on(C.ConstDefine.click, this.headIconClick, this),
                this._headIconSpt = l.getChildByName(C.ConstDefine.Background).getComponent(cc.Sprite);
                var g = n.getChildByName(C.ConstDefine.account);
                this._loginNodes.push(g),
                this._accountLable = g.getComponent(cc.Label),
                this._coinCountbarNode = n.getChildByName("coinCountbar"),
                ...
                for (var v = this._coinCountbarNode.getChildByName("jp"), S = 0, w = v.children; S < w.length; S++) {
                    var N = w[S];
                    this._langNode.push(N.getChildByName("bg")),
                    this._jpCredit.push(new f.default("jp",N.getChildByName(C.ConstDefine.credit)))
                }
                this.initRollJpCredit(),
                u.EffectMgr.Instance.trigger(u.EffectMgr.EffectType.EffectMeetCondition, .05, this.rollJpCredit.bind(this), C.ConstDefine.emptyFunc),
                this._browseNodes.push(v),
                this._coinCountbar = this._coinCountbarNode.children;
                var B = this._coinCountbar[0];
                this._singleCreditNode = B.getChildByName(C.ConstDefine.credit),
                this._singleCreditUIPic = new f.default(C.ConstDefine.credit,this._singleCreditNode);
                var P = this._coinCountbar[1];
                this._langNode.push(P.getChildByName("bg")),
                this._doubleCreditNode = P.getChildByName(C.ConstDefine.credit),
                ...
                var k = this.nodeInfo.root.getChildByName("right");
                this._lastNode = k.getChildByName("last"),
                this._nextNode = k.getChildByName("next");
                var R = this.nodeInfo.root.getChildByName("bottom");
                t.push(R.getChildByName("shengdan"));
                var T = R.getComponent(cc.Animation);
                this._animsReplay.push(T);
                var I = R.getChildByName("quit");
                this._langNode.push(I.getChildByName("lang")),
                this._loginNodes.push(I),
                I.on(C.ConstDefine.click, this.quit, this),
                this._jackpotNode = R.getChildByName("jackpot"),
                ...
                var D = R.getChildByName("login");
                this._langNode.push(D.getChildByName("loginText")),
                this._browseNodes.push(D),
                D.getChildByName("btn").on(C.ConstDefine.click, function() {
                    _.default.playEffect(C.ConstDefine.click),
                    b.default.getResInfo(C.ConstDefine.loginUI)
                });
                for (var L = R.getChildByName("floatCtrl"), x = 0, E = L.children; x < E.length; x++) {
                    var O = E[x];
                    this._langNode.push(O.getChildByName("text")),
                    cc.tween(O.getChildByName("frame")).to(2, {
                        y: 1
                    }, {
                        easing: "sineInOut"
                    }).to(2, {
                ...
                var F = L.getChildByName("noticeTip");
                this._bottomAnimsReplay.push(F.getComponent(cc.Animation)),
                F.on(C.ConstDefine.click, function() {
                    C.default.browsePage || (_.default.playEffect(C.ConstDefine.click),
                    b.default.getResInfo("noticeTip"))
                });
                var A = L.getChildByName(C.ConstDefine.password);
                this._bottomAnimsReplay.push(A.getComponent(cc.Animation)),
                A.on(C.ConstDefine.click, function() {
                    C.default.browsePage || (_.default.playEffect(C.ConstDefine.click),
                    b.default.getResInfo("modPwdBox"))
                });
                var j = L.getChildByName("setting");
                this._bottomAnimsReplay.push(j.getComponent(cc.Animation)),
                j.on(C.ConstDefine.click, function() {
                    _.default.playEffect(C.ConstDefine.click),
                    b.default.getResInfo("settingBox")
                });
                var U = L.getChildByName("share");
                this._bottomAnimsReplay.push(U.getComponent(cc.Animation)),
                U.on(C.ConstDefine.click, function() {
                    _.default.playEffect(C.ConstDefine.click),
                ...
                var H = this._midNode.getChildByName("left");
                this._animsReplay.push(H.getComponent(cc.Animation));
                for (var G = function(t) {
                    var o = H.children[t];
                    z._langNode.push(o.getChildByName("Background")),
                    z._langNode.push(o.getChildByName("checkmark")),
                    z._leftToggle.push(o.getComponent(cc.Toggle)),
                    o.on(C.ConstDefine.click, function() {
                        C.default.browsePage || (_.default.playEffect(C.ConstDefine.click),
                        e.leftClick(t + 1, 0))
                    })
                }, z = this, V = 0; V < H.childrenCount; V++)
                    G(V);
                k = this._midNode.getChildByName("right");
                var W = cc.find("view/content", k);
                this._contentChildren = W.children;
                var J = W.getChildByName("page1");
                J.active = !0,
                this._page1CardRoot = J.getChildByName("card");
                var q = J.getChildByName("ad");
                b.default.getResInfo("advert", q);
                var K = this.nodeInfo.root.getChildByName("dayPrize")
                  , X = K.getChildByName("btn");
                this._dayPrizeBtn = X.getComponent(cc.Button),
                X.on(C.ConstDefine.click, this.dayPrizeClick, this),
                this._dayPrizeAnim = X.getComponent(cc.Animation),
                this._dayPrizeTimeNode = K.getChildByName("time"),
                ...
                this._loginNodes.push(K),
                this._pagePrefab = W.getChildByName("page2"),
                b.default.getResInfo("card").then(function(t) {
                    ...
                    var l = k.getComponent(cc.PageView)
                      , f = e._cards.length;
                    if (f <= 6)
                    ...
                    var v = {
                        ...
                        finishCall: function() {
                            ...
                            c.MessageMgr.once(c.MessageName.NetOpen, function() {
                                p.NetMgr.send(d.Cmd.MDM_MB_LOGON, d.Cmd.SUB_MB_LOGON_GETGAMESERVER, {
                                    userid: 0
                                })
                            }))
                        },
                ...
                for (var Z = 0, Y = this._loginNodes; Z < Y.length; Z++)
                    (O = Y[Z]).active = !1;
                for (var Q = 0, $ = this._browseNodes; Q < $.length; Q++)
                    (O = $[Q]).active = !1;
                for (var ee = 0, te = t; ee < te.length; ee++) {
                    var oe = te[ee];
                    "shengdan" == h.Config.theme ? oe.active = !0 : oe.destroy()
                }
            ...
            ,
            t.prototype.onLogonNet = function(e) {
                if (e.mainID === d.Cmd.MDM_MB_LOGON)
                    switch (e.subID) {
                    case d.Cmd.SUB_MB_GETJPSCORE_RESULT:
                        var t = e.data;
                        ...
                        this._jackpotUIPic.setSepValue(C.default.jpTotalCredit),
                        cc.js.array.fastRemove(C.default.netClose, d.Cmd.SUB_MB_LOGON_GETJPSCORE),
            ...
            t.prototype.initParams = function() {
                ...
                f.default.bundles[a.Config.dyncLoadDirIndex.headIcon].loadDir("headIcon", cc.SpriteFrame, function(e, o) {
                    if (e)
                        ...
                        for (var f = Math.ceil(i / t._perPgNum), u = 1; u < f; u++) {
                            var d = cc.instantiate(l);
                            a.addPage(d)
                        }
                        var p = f * t._perPgNum - i
                          , g = r.children[f - 1];
                        for (u = t._perPgNum - p; u < t._perPgNum; u++)
                            g.children[u].destroy();
                        var _ = function(e) {
    ...
    JpRankUI: [function(e, t, o) {
        ...
        var r, a = e("../../base/SoundMgr"), s = e("./CustomScrollView"), c = e("../../base/LogicMgr"), l = e("../../base/common/view/UIPicText"), f = e("../../base/common/view/Tip"), h = e("../../base/common/MessageMgr"), u = e("../../base/net/NetMgr"), d = e("../../base/net/EEvent"), p = e("../../base/common/Func"), g = e("../../base/res/LanguageMgr"), _ = e("../../base/common/SpecialFunc");
        (function(e) {
            e[e.noData = 0] = "noData",
        ...
        var y = ["grand", "major", "minor", "mini"]
          ...
          , v = function(e) {
            ...
            t.prototype.initParams = function() {
                ...
                var u = h.getChildByName("rank");
                s.CustomScrollView.addScrollBarExtra(u),
                this._contentNode = cc.find("view/content", u),
            ...
            t.prototype.toggleClick = function(e) {
                ...
                c.default.login.succeed && (h.MessageMgr.once(h.MessageName.NetOpen, function() {
                    ...
                    u.NetMgr.send(d.Cmd.MDM_MB_LOGON, d.Cmd.SUB_MB_LOGON_GETJPRECORD, t)
                }),
                u.NetMgr.createWebSocket()))
            }
            ,
        ...
        var r = e("../../base/SoundMgr")
          ...
          , p = function(e) {
            ...
            t.prototype.recordClick = function(e) {
                ...
                u.default.getResInfo("jpRankUI", e)
            }
            ,
            t.prototype.netClose = function() {}
            ,
        ...
        var g = function(e) {
            ...
            t.prototype.initParams = function() {
                ...
                for (var e = this.nodeInfo.root.getChildByName("award").children, t = 0; t < e.length; t++)
                    this._awardBrand[t] = new d(t,e[t])
            }
            ,
    ...
    LabelShader1: [function(e, t, o) {
        ...
        var a = cc._decorator
          ...
          , g = function(e) {
            ...
            r([c({
                visible: function() {
                    return this.gradient > d.None
                }
            })], t.prototype, "color1", void 0),
            r([c({
                visible: function() {
                    return this.gradient > d.OneColor
                }
            })], t.prototype, "color2", void 0),
            r([c({
                visible: function() {
                    return this.gradient > d.TwoColor
                }
            ...
            r([s, l("UI/LabelShader1"), f(cc.Label), h(), u()], t)
        }(cc.Component);
        o.default = g,
        cc._RF.pop()
    }
    ...
    LanguageMgr: [function(e, t, o) {
        ...
        var h = function(e) {
            ...
            return i(t, e),
            t.prototype.init = function() {
                this.label.string = u.procLangText(this.name)
            }
            ,
            t
        }(f);
            ...
            t.prototype.fillBuffers = function(t, o) {
                ...
                c) {
                    ...
                    for (var l, f = 1, h = 0; h < r.length; ) {
                        var u = r[h++];
                        i = u.__gtDirtyFlag;
                        for (var d = 0, p = u.children; d < p.length; d++) {
                            var g = p[d];
    ...
    LogicMgr: [function(e, t, o) {
        ...
        var n = function() {
            ...
            e.cardShow = function(e) {
                return !!e && (this.login.testAcccount || e.t === u.GameTag.comingSoon || !e.testGame && e.mixed || this.browsePage)
            }
            ,
    ...
    LoginUI: [function(e, t, o) {
        ...
        o.LoginUI = void 0;
        var r, a = e("../../base/common/Func"), s = e("../config/Config"), c = e("../../base/res/LanguageMgr"), l = e("../../base/common/MessageMgr"), f = e("../../base/common/SpecialFunc"), h = e("../../base/SoundMgr"), u = e("../../base/res/DyncLoadedBase"), d = e("../../base/res/DyncMgr"), p = e("../../base/LogicMgr");
        (function(e) {
        ...
        var g = function(e) {
            ...
            t.prototype.initParams = function() {
                ...
                d.default.isLoad(p.ConstDefine.hallUI) || d.default.getResInfo(p.ConstDefine.hallUI);
                ...
                var u = e.getChildByName("close");
                "loginUI" == s.Config.beginPage ? u.active = !1 : u.on(p.ConstDefine.click, this.close, this);
            ...
            t.prototype.loginFail = function() {
                var e = this;
                d.default.getResInfo(p.ConstDefine.loadingTip),
                setTimeout(function() {
                    d.default.hide(p.ConstDefine.loadingTip),
            ...
            t.prototype.close = function() {
                ...
                d.default.getResInfo(p.ConstDefine.hallUI),
                e.prototype.close.call(this)
            }
            ,
            t.prototype.hide = function() {
            ...
            t.prototype.touchStart = function() {
                d.default.isLoad("keyboardUI") || h.default.playEffect(p.ConstDefine.click)
            }
            ,
            ...
            t.prototype.forget = function() {
                ...
                d.default.getResInfo(p.ConstDefine.msgPromptBox, c.default.procLangText("forgetTip"))
            }
            ,
            ...
            t.prototype.login = function() {
                ...
                switch (!0) {
                case 0 === e.length:
                    d.default.getResInfo(p.ConstDefine.msgTip, c.default.procLangText("accountEmptyTip"), 2, !0);
                    break;
                case 0 === t.length:
                    d.default.getResInfo(p.ConstDefine.msgTip, c.default.procLangText("pwdEmptyTip"), 2, !0);
                    break;
                default:
    ...
    Main: [function(e, t, o) {
        ...
        function(e) {
            ...
            t.prototype.start = function() {
                ...
                c.Config.configPath = c.Config.basePath + "plat/config/hall/" + c.Config.platName + "/",
                cc.game.canvas.style.cursor = "url('" + c.Config.configPath + "cursor.png'), pointer",
                cc.sys.isBrowser) {
                    var i = new Date
                      , r = c.Config.configPath + "config.json?=" + i.getTime();
                    f.NetMgr.sendHttpGet(r, this.quaryLoginConfigCB.bind(this)),
                    this.quaryMsg()
                } else
            ...
            t.prototype.quaryLoginConfigCB = function(e) {
                ...
                d.default.isRotateDev() ? p.default.useSoftKeyboard = !0 : p.default.useSoftKeyboard = c.Config.pcUseSoftKey;
            ...
            t.prototype.registerEvent = function() {
                d.default.isRotateDev() && (cc.game.canvas.addEventListener("blur", function() {
          ...
          , _ = function(e) {
            ...
            t.prototype.onLogonNet = function(e) {
                if (e.mainID === h.Cmd.MDM_MB_LOGON && e.subID == h.Cmd.SUB_MB_CHANGEPASSWORD_RESULT) {
                    var t = e.data;
                    u.default.getResInfo(s.ConstDefine.msgTip, g.default.procBsText(t.msg), 5, !0),
                    0 == t.result && (s.default.needReset = !1,
                    s.default.login.pwd = d.default.encryMd5(this._newPwdStr),
                ...
                if ("" !== t && "" !== this._newPwdStr && "" !== o) {
                    if (!s.default.login.testAcccount) {
                        if (this._newPwdStr.length < r.Config.accPwdMinLength || this._newPwdStr.length > r.Config.accPwdMaxLength)
                            return void u.default.getResInfo(s.ConstDefine.msgTip, g.default.procLangText("lengthTip"), 2, !0);
                        if (!new RegExp("(?=.*[0-9])(?=.*[a-zA-Z])").test(this._newPwdStr))
                            return void u.default.getResInfo(s.ConstDefine.msgTip, g.default.procLangText("pwdFormatTip"), 2, !0)
                    }
                    ...
                    this._cfmTimeOut = setTimeout(function() {
                        ...
                        u.default.getResInfo(s.ConstDefine.msgTip, g.default.procLangText("badNetStatus")),
                        f.MessageMgr.off(f.MessageName.NetOpen, e.netOpen, e)
                    }, 5e3)) : u.default.getResInfo(s.ConstDefine.msgTip, g.default.procLangText("noSameTip"), 2, !0) : u.default.getResInfo(s.ConstDefine.msgTip, g.default.procLangText("pwdunlikeTip"), 2, !0)
                } else
                    u.default.getResInfo(s.ConstDefine.msgTip, g.default.procLangText("pwdNotEmptyTip"), 2, !0)
            }
            ,
            t.prototype.netOpen = function() {
                var e = {
    ...
    MutabResCfg: [function(e, t, o) {
        ...
        for (var G = 0, z = R = ["announcement", "music", "setting", "sound", "music1", "music2", "music3", "music4", "music5", "music6", "randomPlay", "binddevice", "unboundA", "unboundB", "jpRecord", "total", "grand", "major", "minor", "mini", "order", "userID", "jackpot", "time", "bounus", "noData", "noRecordLst", "ranking"]; G < z.length; G++)
            E = z[G],
            o.DyncResCfg[E] = {
            ...
            t.prototype.pageChange = function() {
                if (!(this._pgView.pageCount <= 1))
                    if (this._pgView.isEnd()) {
                        for (var e = this._btnNode[d.last], t = 0; t < e.length; ++t)
                            e[t].active = !0;
                        var o = this._btnNode[d.next];
        ...
        var r = e("../../base/common/MessageMgr")
          ...
          , y = function(e) {
            ...
            t.prototype.initParams = function() {
                ...
                this._closeNode = o.getChildByName(d.ConstDefine.close),
                this._closeNode.on(d.ConstDefine.click, this.close, this),
                ...
                c.getChildByName(d.ConstDefine.text).getComponent(cc.Label).string = "GOOD LUCK";
                ...
                f = 0; f < s.Config.prizeNum; ++f) {
                    ...
                    0 !== g && (p.getChildByName(d.ConstDefine.text).getComponent(cc.Label).string = a.default.convertDecimalNum(g))
                }
                c.destroy(),
                ...
                m.on(d.ConstDefine.click, this.getPrize, this),
            ...
            t.prototype.resetParams = function() {
                ...
                this._jinbiNode.setPosition(d.ConstDefine.vec3ZERO);
                for (var t = 0, o = this._jinbiNode.children; t < o.length; t++)
                    o[t].setScale(0);
            ...
            t.prototype.jinbiMove = function() {
                ...
                var i = d.default.creditNode.parent.convertToWorldSpaceAR(d.default.creditNode.position);
                this._jinbiNode.parent.convertToNodeSpaceAR(i, _),
                cc.tween(this._jinbiNode).to(1.5, {
                    position: _
                }).call(function() {
                    d.default.reqUserInfo(),
                    e.hide()
                }).start()
            }
            ,
            ...
            t.prototype.rotateEnd = function() {
                ...
                this._prizeVal > 0 ? setTimeout(this.showWinTip.bind(this), 1e3) : (d.default.reqUserInfo(),
                setTimeout(function() {
            ...
            t.prototype.netOpen = function() {
                ...
                u.NetMgr.send(c.Cmd.MDM_MB_LOGON, c.Cmd.SUB_MB_LOGON_CHOUJIANG, e)
            }
            ,
            t.prototype.onLogonNet = function(e) {
                var t = this;
                if (e.mainID === c.Cmd.MDM_MB_LOGON && e.subID === c.Cmd.SUB_MB_LOGON_CHOUJIANG_RESULT) {
                    var o = e.data;
                    if (0 != o.result)
                        return void ("" != o.msg && p.default.getResInfo(d.ConstDefine.msgTip, g.default.procBsText(o.msg), 5));
                    ...
                    e.prototype.fillBuffers = function(e, t) {
                        if (this._ia) {
                            ...
                            if (0 !== o) {
                                ...
                                for (var u = r._iData, d = a.indiceOffset, p = a.vertexOffset, g = 6 * o, _ = 0; _ < g; _++)
                                    u[d++] = p + f[_]
                            }
                        }
                    }
    ...
    ScreenMgr: [function(e, t, o) {
        ...
        var a, s, c, l = e("./common/MessageMgr"), f = e("../my/config/Config"), h = e("./res/DyncMgr"), u = e("./common/SpecialFunc"), d = e("./LogicMgr");
        (function(e) {
        ...
        var m = function(e) {
            ...
            t.prototype.fitScreen = function() {
                u.default.isRotateDev() && (cc.view.setDesignResolutionSize(f.Config.gameSize[0], f.Config.gameSize[1], cc.ResolutionPolicy.SHOW_ALL),
            ...
            t.prototype.playClickAnim = function(e) {
                var t = e.getLocation();
                h.default.getResInfo(d.ConstDefine.click, this.node.convertToNodeSpaceAR(t))
            }
            ,
            o = r([g, _(-5)], t)
        }(cc.Component);
        ...
        var r = e("../../base/SoundMgr")
          ...
          , h = function(e) {
            ...
            t.prototype.initParams = function() {
                ...
                }, h = this, u = 0; u < s.length; u++)
                    f(u);
                var d = localStorage.getItem("hMS");
                if (d) {
                    var p = Number(d);
    ...
    SoundMgr: [function(e, t, o) {
        ...
        var n, i, r = e("./common/Func"), a = e("./common/MessageMgr"), s = e("../my/config/Config"), c = e("./effect/EffectMgr"), l = e("./res/DyncMgr"), f = e("./res/LanguageMgr"), h = e("./LogicMgr"), u = "bg", d = null, p = null, g = 1, _ = 1, y = !0, m = !1, v = !1, b = function() {
            function e() {}
            ...
            e.beginPlayMusic = function() {
                ...
                e ? this.playBGM(e, !0) : this.playBGM(u, !0);
            ...
            e.playMultiBgm = function(e, t, o) {
                ...
                if (!(f <= t) || e.loop) {
                    ...
                    e.timer = c.EffectMgr.Instance.trigger(c.EffectMgr.EffectType.EffectMeetCondition, .01, function() {
                        if (!e.pause) {
                            if ((u += .01) < _)
                                return p < -.01 && u > _ - .1 && cc.audioEngine.getState(e.curMusicId) == cc.audioEngine.AudioState.PLAYING && (p = cc.audioEngine.getVolume(e.curMusicId)),
                                !1;
                            var o = Date.now() / 1e3;
                ...
                var p = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54]
                  , g = n.AES = o.extend({
                    _doReset: function() {
                        if (!this._nRounds || this._keyPriorReset !== this._key) {
                            ...
                            for (var c = this._invKeySchedule = [], l = 0; l < n; l++)
                                a = n - l,
                                s = l % 4 ? r[a] : r[a - 4],
                                c[l] = l < 4 || a <= 4 ? s : f[i[s >>> 24]] ^ h[i[s >>> 16 & 255]] ^ u[i[s >>> 8 & 255]] ^ d[i[255 & s]]
                        }
                    },
                    ...
                    decryptBlock: function(e, t) {
                        ...
                        e[t + 1] = e[t + 3],
                        e[t + 3] = o,
                        this._doCryptBlock(e, t, this._invKeySchedule, f, h, u, d, r),
                        o = e[t + 1],
                        e[t + 1] = e[t + 3],
                        e[t + 3] = o
                    },
                    _doCryptBlock: function(e, t, o, n, i, r, a, s) {
                        for (var c = this._nRounds, l = e[t] ^ o[0], f = e[t + 1] ^ o[1], h = e[t + 2] ^ o[2], u = e[t + 3] ^ o[3], d = 4, p = 1; p < c; p++) {
                            var g = n[l >>> 24] ^ i[f >>> 16 & 255] ^ r[h >>> 8 & 255] ^ a[255 & u] ^ o[d++]
                              , _ = n[f >>> 24] ^ i[h >>> 16 & 255] ^ r[u >>> 8 & 255] ^ a[255 & l] ^ o[d++]
                              , y = n[h >>> 24] ^ i[u >>> 16 & 255] ^ r[l >>> 8 & 255] ^ a[255 & f] ^ o[d++]
                              , m = n[u >>> 24] ^ i[l >>> 16 & 255] ^ r[f >>> 8 & 255] ^ a[255 & h] ^ o[d++];
                            l = g,
                            f = _,
                            h = y,
                            u = m
                        }
                        g = (s[l >>> 24] << 24 | s[f >>> 16 & 255] << 16 | s[h >>> 8 & 255] << 8 | s[255 & u]) ^ o[d++],
                        _ = (s[f >>> 24] << 24 | s[h >>> 16 & 255] << 16 | s[u >>> 8 & 255] << 8 | s[255 & l]) ^ o[d++],
                        y = (s[h >>> 24] << 24 | s[u >>> 16 & 255] << 16 | s[l >>> 8 & 255] << 8 | s[255 & f]) ^ o[d++],
                        m = (s[u >>> 24] << 24 | s[l >>> 16 & 255] << 16 | s[f >>> 8 & 255] << 8 | s[255 & h]) ^ o[d++],
                        e[t] = g,
                        e[t + 1] = _,
                        e[t + 2] = y,
                        e[t + 3] = m
        ...
        n = function() {
            ...
            function(e) {
                ...
                var s = r.MD5 = i.extend({
                    ...
                    _doProcessBlock: function(e, t) {
                        ...
                        P = u(P, k = h(k, R, T, P, d, 23, a[47]), R, T, s, 6, a[48]),
                        T = u(T, P, k, R, m, 10, a[49]),
                        R = u(R, T, P, k, N, 15, a[50]),
                        k = u(k, R, T, P, _, 21, a[51]),
                        P = u(P, k, R, T, S, 6, a[52]),
                        T = u(T, P, k, R, p, 10, a[53]),
                        R = u(R, T, P, k, C, 15, a[54]),
                        k = u(k, R, T, P, f, 21, a[55]),
                        P = u(P, k, R, T, v, 6, a[56]),
                        T = u(T, P, k, R, B, 10, a[57]),
                        R = u(R, T, P, k, y, 15, a[58]),
                        k = u(k, R, T, P, w, 21, a[59]),
                        P = u(P, k, R, T, g, 6, a[60]),
                        T = u(T, P, k, R, M, 10, a[61]),
                        R = u(R, T, P, k, d, 15, a[62]),
                        k = u(k, R, T, P, b, 21, a[63]),
                        r[0] = r[0] + P | 0,
                        r[1] = r[1] + k | 0,
                        r[2] = r[2] + R | 0,
                        r[3] = r[3] + T | 0
            ...
            function(e) {
                ...
                var c = []
                  , l = r.SHA256 = i.extend({
                    ...
                    _doProcessBlock: function(e, t) {
                        for (var o = this._hash.words, n = o[0], i = o[1], r = o[2], a = o[3], l = o[4], f = o[5], h = o[6], u = o[7], d = 0; d < 64; d++) {
                            if (d < 16)
                                c[d] = 0 | e[t + d];
                            else {
                                var p = c[d - 15]
                            ...
                            var m = n & i ^ n & r ^ i & r
                              ...
                              , b = u + ((l << 26 | l >>> 6) ^ (l << 21 | l >>> 11) ^ (l << 7 | l >>> 25)) + (l & f ^ ~l & h) + s[d] + c[d];
                            u = h,
                            h = f,
                            f = l,
                            l = a + b | 0,
                ...
                var e = f
                  ...
                  , u = i.RIPEMD160 = n.extend({
                    ...
                    _doProcessBlock: function(e, t) {
                        ...
                        var f, u, v, b, C, M, S, w, N, B, P, k = this._hash.words, R = l.words, T = h.words, I = r.words, D = a.words, L = s.words, x = c.words;
                        for (M = f = k[0],
                        S = u = k[1],
                        w = v = k[2],
                        N = b = k[3],
                        ...
                        o = 0; o < 80; o += 1)
                            P = f + e[t + I[o]] | 0,
                            P += o < 16 ? d(u, v, b) + R[0] : o < 32 ? p(u, v, b) + R[1] : o < 48 ? g(u, v, b) + R[2] : o < 64 ? _(u, v, b) + R[3] : y(u, v, b) + R[4],
                            P = (P = m(P |= 0, L[o])) + C | 0,
                            f = C,
                            C = b,
                            b = m(v, 10),
                            ...
                            u = P,
                            P = M + e[t + D[o]] | 0,
                            P += o < 16 ? y(S, w, N) + T[0] : o < 32 ? _(S, w, N) + T[1] : o < 48 ? g(S, w, N) + T[2] : o < 64 ? p(S, w, N) + T[3] : d(S, w, N) + T[4],
                            P = (P = m(P |= 0, x[o])) + B | 0,
                            M = B,
                            B = N,
                            N = m(w, 10),
                  ...
                  , s = i.PBKDF2 = o.extend({
                    ...
                    compute: function(e, t) {
                        for (var o = this.cfg, i = a.create(o.hasher, e), r = n.create(), s = n.create([1]), c = r.words, l = s.words, f = o.keySize, h = o.iterations; c.length < f; ) {
                            ...
                            i.reset();
                            for (var d = u.words, p = d.length, g = u, _ = 1; _ < h; _++) {
                                g = i.finalize(g),
                                i.reset();
            ...
            function() {
                ...
                var l = r.SHA512 = t.extend({
                    ...
                    _doProcessBlock: function(e, t) {
                        for (var o = this._hash.words, n = o[0], i = o[1], r = o[2], a = o[3], l = o[4], f = o[5], h = o[6], u = o[7], d = n.high, p = n.low, g = i.high, _ = i.low, y = r.high, m = r.low, v = a.high, b = a.low, C = l.high, M = l.low, S = f.high, w = f.low, N = h.high, B = h.low, P = u.high, k = u.low, R = d, T = p, I = g, D = _, L = y, x = m, E = v, O = b, F = C, A = M, j = S, U = w, H = N, G = B, z = P, V = k, W = 0; W < 80; W++) {
                            var J = c[W];
                            if (W < 16)
                            ...
                            var he, ue = F & j ^ ~F & H, de = A & U ^ ~A & G, pe = R & I ^ R & L ^ I & L, ge = T & D ^ T & x ^ D & x, _e = (R >>> 28 | T << 4) ^ (R << 30 | T >>> 2) ^ (R << 25 | T >>> 7), ye = (T >>> 28 | R << 4) ^ (T << 30 | R >>> 2) ^ (T << 25 | R >>> 7), me = (F >>> 14 | A << 18) ^ (F >>> 18 | A << 14) ^ (F << 23 | A >>> 9), ve = (A >>> 14 | F << 18) ^ (A >>> 18 | F << 14) ^ (A << 23 | F >>> 9), be = s[W], Ce = be.high, Me = be.low, Se = z + me + ((he = V + ve) >>> 0 < V >>> 0 ? 1 : 0), we = ye + ge;
                            z = H,
                            V = G,
                            H = j,
                            G = U,
                            j = F,
                            U = A,
                            F = E + (Se = (Se = (Se = Se + ue + ((he += de) >>> 0 < de >>> 0 ? 1 : 0)) + Ce + ((he += Me) >>> 0 < Me >>> 0 ? 1 : 0)) + q + ((he += K) >>> 0 < K >>> 0 ? 1 : 0)) + ((A = O + he | 0) >>> 0 < O >>> 0 ? 1 : 0) | 0,
                            E = L,
                            O = x,
                            L = I,
                            x = D,
                        ...
                        B = h.low = B + G,
                        h.high = N + H + (B >>> 0 < G >>> 0 ? 1 : 0),
                        k = u.low = k + V,
                        u.high = P + z + (k >>> 0 < V >>> 0 ? 1 : 0)
                    },
                    _doFinalize: function() {
                        var e = this._data
                          , t = e.words
                ...
                var p = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54]
                  , g = o.AES = t.extend({
                    _doReset: function() {
                        if (!this._nRounds || this._keyPriorReset !== this._key) {
                            ...
                            for (var c = this._invKeySchedule = [], f = 0; f < i; f++)
                                a = i - f,
                                s = f % 4 ? r[a] : r[a - 4],
                                c[f] = f < 4 || a <= 4 ? s : l[n[s >>> 24]] ^ h[n[s >>> 16 & 255]] ^ u[n[s >>> 8 & 255]] ^ d[n[255 & s]]
                        }
                    },
                    encryptBlock: function(e, t) {
                    ...
                    decryptBlock: function(e, t) {
                        ...
                        e[t + 1] = e[t + 3],
                        e[t + 3] = o,
                        this._doCryptBlock(e, t, this._invKeySchedule, l, h, u, d, i),
                        o = e[t + 1],
                        e[t + 1] = e[t + 3],
                        e[t + 3] = o
                    },
            ...
            return function(t) {
                ...
                var c = a.MD5 = r.extend({
                    ...
                    _doProcessBlock: function(e, t) {
                        ...
                        P = u(P, k = h(k, R, T, P, d, 23, s[47]), R, T, a, 6, s[48]),
                        T = u(T, P, k, R, m, 10, s[49]),
                        R = u(R, T, P, k, N, 15, s[50]),
                        k = u(k, R, T, P, _, 21, s[51]),
                        P = u(P, k, R, T, S, 6, s[52]),
                        T = u(T, P, k, R, p, 10, s[53]),
                        R = u(R, T, P, k, C, 15, s[54]),
                        k = u(k, R, T, P, c, 21, s[55]),
                        P = u(P, k, R, T, v, 6, s[56]),
                        T = u(T, P, k, R, B, 10, s[57]),
                        R = u(R, T, P, k, y, 15, s[58]),
                        k = u(k, R, T, P, w, 21, s[59]),
                        P = u(P, k, R, T, g, 6, s[60]),
                        T = u(T, P, k, R, M, 10, s[61]),
                        R = u(R, T, P, k, d, 15, s[62]),
                        k = u(k, R, T, P, b, 21, s[63]),
                        r[0] = r[0] + P | 0,
                        r[1] = r[1] + k | 0,
                        r[2] = r[2] + R | 0,
                        r[3] = r[3] + T | 0
                ...
                var t = e
                  ...
                  , u = r.RIPEMD160 = i.extend({
                    ...
                    _doProcessBlock: function(e, t) {
                        ...
                        var r, u, v, b, C, M, S, w, N, B, P, k = this._hash.words, R = f.words, T = h.words, I = a.words, D = s.words, L = c.words, x = l.words;
                        for (M = r = k[0],
                        S = u = k[1],
                        w = v = k[2],
                        N = b = k[3],
            ...
            return function(t) {
                ...
                var l = []
                  , f = a.SHA256 = r.extend({
                    ...
                    _doProcessBlock: function(e, t) {
                        for (var o = this._hash.words, n = o[0], i = o[1], r = o[2], a = o[3], s = o[4], f = o[5], h = o[6], u = o[7], d = 0; d < 64; d++) {
                            if (d < 16)
                                l[d] = 0 | e[t + d];
                            else {
                                var p = l[d - 15]
                            ...
                            var m = n & i ^ n & r ^ i & r
                              , v = (n << 30 | n >>> 2) ^ (n << 19 | n >>> 13) ^ (n << 10 | n >>> 22)
                              , b = u + ((s << 26 | s >>> 6) ^ (s << 21 | s >>> 11) ^ (s << 7 | s >>> 25)) + (s & f ^ ~s & h) + c[d] + l[d];
                            u = h,
                            h = f,
                            f = s,
                            s = a + b | 0,
    ...
    sha3: [function(e, t, o) {
        ...
        n = function(e) {
            return function(t) {
                ...
                o.SHA3 = r._createHelper(u),
                o.HmacSHA3 = r._createHmacHelper(u)
            }(Math),
            e.SHA3
        }
        ,
        ...
        n = function(e) {
            return function() {
                ...
                var f = a.SHA512 = o.extend({
                    ...
                    _doProcessBlock: function(e, t) {
                        for (var o = this._hash.words, n = o[0], i = o[1], r = o[2], a = o[3], s = o[4], f = o[5], h = o[6], u = o[7], d = n.high, p = n.low, g = i.high, _ = i.low, y = r.high, m = r.low, v = a.high, b = a.low, C = s.high, M = s.low, S = f.high, w = f.low, N = h.high, B = h.low, P = u.high, k = u.low, R = d, T = p, I = g, D = _, L = y, x = m, E = v, O = b, F = C, A = M, j = S, U = w, H = N, G = B, z = P, V = k, W = 0; W < 80; W++) {
                            var J = l[W];
                            if (W < 16)
                                var q = J.high = 0 | e[t + 2 * W]
                                  , K = J.low = 0 | e[t + 2 * W + 1];
                            ...
                            var he, ue = F & j ^ ~F & H, de = A & U ^ ~A & G, pe = R & I ^ R & L ^ I & L, ge = T & D ^ T & x ^ D & x, _e = (R >>> 28 | T << 4) ^ (R << 30 | T >>> 2) ^ (R << 25 | T >>> 7), ye = (T >>> 28 | R << 4) ^ (T << 30 | R >>> 2) ^ (T << 25 | R >>> 7), me = (F >>> 14 | A << 18) ^ (F >>> 18 | A << 14) ^ (F << 23 | A >>> 9), ve = (A >>> 14 | F << 18) ^ (A >>> 18 | F << 14) ^ (A << 23 | F >>> 9), be = c[W], Ce = be.high, Me = be.low, Se = z + me + ((he = V + ve) >>> 0 < V >>> 0 ? 1 : 0), we = ye + ge;
                            z = H,
                            V = G,
                            H = j,
                            G = U,
